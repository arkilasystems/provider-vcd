...
// GetInitParameters of this NetworkIsolatedV2
func (tr *NetworkIsolatedV2) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NetworkIsolatedV2
func (tr *NetworkIsolatedV2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
