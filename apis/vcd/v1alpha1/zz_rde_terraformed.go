...
// GetInitParameters of this Rde
func (tr *Rde) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Rde
func (tr *Rde) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
