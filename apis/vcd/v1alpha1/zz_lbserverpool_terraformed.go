...
// GetInitParameters of this LbServerPool
func (tr *LbServerPool) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LbServerPool
func (tr *LbServerPool) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
