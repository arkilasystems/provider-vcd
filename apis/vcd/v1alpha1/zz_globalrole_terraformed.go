...
// GetInitParameters of this GlobalRole
func (tr *GlobalRole) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this GlobalRole
func (tr *GlobalRole) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
