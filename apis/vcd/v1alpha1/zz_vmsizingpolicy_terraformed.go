...
// GetInitParameters of this VmSizingPolicy
func (tr *VmSizingPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VmSizingPolicy
func (tr *VmSizingPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VmSizingPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VmSizingPolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &VmSizingPolicyParameters{}
