...
// GetInitParameters of this UiPlugin
func (tr *UiPlugin) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this UiPlugin
func (tr *UiPlugin) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
