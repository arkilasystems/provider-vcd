...
type NsxvIpSetInitParameters struct {
...
type NsxvIpSetSpec struct {
	...
	// autoscaler.
	InitProvider NsxvIpSetInitParameters `json:"initProvider,omitempty"`
}
...
// NsxvIpSet is the Schema for the NsxvIpSets API. Provides an IP set resource.
