...
// GetInitParameters of this IpSpaceUplink
func (tr *IpSpaceUplink) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IpSpaceUplink
func (tr *IpSpaceUplink) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
