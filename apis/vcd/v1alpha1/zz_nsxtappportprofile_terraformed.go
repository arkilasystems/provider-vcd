...
// GetInitParameters of this NsxtAppPortProfile
func (tr *NsxtAppPortProfile) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtAppPortProfile
func (tr *NsxtAppPortProfile) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
