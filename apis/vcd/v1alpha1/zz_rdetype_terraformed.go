...
// GetInitParameters of this RdeType
func (tr *RdeType) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RdeType
func (tr *RdeType) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
