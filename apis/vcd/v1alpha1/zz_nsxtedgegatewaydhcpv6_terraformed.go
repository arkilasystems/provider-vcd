...
// GetInitParameters of this NsxtEdgeGatewayDhcpV6
func (tr *NsxtEdgeGatewayDhcpV6) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtEdgeGatewayDhcpV6
func (tr *NsxtEdgeGatewayDhcpV6) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
