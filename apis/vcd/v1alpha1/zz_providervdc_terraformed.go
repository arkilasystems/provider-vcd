...
// GetInitParameters of this ProviderVdc
func (tr *ProviderVdc) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ProviderVdc
func (tr *ProviderVdc) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
