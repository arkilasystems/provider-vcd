...
// GetInitParameters of this RdeInterfaceBehavior
func (tr *RdeInterfaceBehavior) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RdeInterfaceBehavior
func (tr *RdeInterfaceBehavior) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
