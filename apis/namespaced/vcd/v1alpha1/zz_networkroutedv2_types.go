...
type NetworkRoutedV2InitParameters struct {
	...
	MetadataEntry []NetworkRoutedV2MetadataEntryInitParameters `json:"metadataEntry,omitempty" tf:"metadata_entry,omitempty"`
	...
	SecondaryStaticIPPool []NetworkRoutedV2SecondaryStaticIPPoolInitParameters `json:"secondaryStaticIpPool,omitempty" tf:"secondary_static_ip_pool,omitempty"`
	...
	StaticIPPool []NetworkRoutedV2StaticIPPoolInitParameters `json:"staticIpPool,omitempty" tf:"static_ip_pool,omitempty"`
...
type NetworkRoutedV2MetadataEntryInitParameters struct {
...
type NetworkRoutedV2SecondaryStaticIPPoolInitParameters struct {
...
type NetworkRoutedV2StaticIPPoolInitParameters struct {
...
type NetworkRoutedV2Spec struct {
	...
	// autoscaler.
	InitProvider NetworkRoutedV2InitParameters `json:"initProvider,omitempty"`
}
...
// NetworkRoutedV2 is the Schema for the NetworkRoutedV2s API. Provides a VMware Cloud Director Org VDC routed Network. This can be used to create, modify, and delete routed VDC networks (backed by NSX-T or NSX-V).
