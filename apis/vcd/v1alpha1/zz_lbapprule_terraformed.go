...
// GetInitParameters of this LbAppRule
func (tr *LbAppRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LbAppRule
func (tr *LbAppRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
