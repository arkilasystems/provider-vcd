...
package nsxtedgegatewayratelimit
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["vcd_nsxt_edgegateway_rate_limiting"], tjcontroller.WithLogger(o.Logger), tjcontroller.WithConnectorEventHandler(eventHandler),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&v1alpha1.NsxtEdgeGatewayRateLimit{}, eventHandler).
