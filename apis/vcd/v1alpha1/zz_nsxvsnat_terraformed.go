...
// GetInitParameters of this NsxvSnat
func (tr *NsxvSnat) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxvSnat
func (tr *NsxvSnat) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
