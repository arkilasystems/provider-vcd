...
// GetInitParameters of this ExternalNetwork
func (tr *ExternalNetwork) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ExternalNetwork
func (tr *ExternalNetwork) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
