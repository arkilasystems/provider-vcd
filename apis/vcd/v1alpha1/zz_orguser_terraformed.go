...
// GetInitParameters of this OrgUser
func (tr *OrgUser) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this OrgUser
func (tr *OrgUser) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
