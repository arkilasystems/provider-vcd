...
// GetInitParameters of this NsxtDistributedFirewallRule
func (tr *NsxtDistributedFirewallRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtDistributedFirewallRule
func (tr *NsxtDistributedFirewallRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
