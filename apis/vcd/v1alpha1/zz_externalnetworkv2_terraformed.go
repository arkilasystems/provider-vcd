...
// GetInitParameters of this ExternalNetworkV2
func (tr *ExternalNetworkV2) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ExternalNetworkV2
func (tr *ExternalNetworkV2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
