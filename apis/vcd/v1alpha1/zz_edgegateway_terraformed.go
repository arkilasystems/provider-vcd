...
// GetInitParameters of this Edgegateway
func (tr *Edgegateway) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Edgegateway
func (tr *Edgegateway) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
