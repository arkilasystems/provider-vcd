...
// GetInitParameters of this NsxtAlbPool
func (tr *NsxtAlbPool) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtAlbPool
func (tr *NsxtAlbPool) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
