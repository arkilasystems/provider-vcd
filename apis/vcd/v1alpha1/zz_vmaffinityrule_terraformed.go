...
// GetInitParameters of this VmAffinityRule
func (tr *VmAffinityRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VmAffinityRule
func (tr *VmAffinityRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VmAffinityRule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VmAffinityRule) LateInitialize(attrs []byte) (bool, error) {
	params := &VmAffinityRuleParameters{}
