...
// GetInitParameters of this IndependentDisk
func (tr *IndependentDisk) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IndependentDisk
func (tr *IndependentDisk) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
