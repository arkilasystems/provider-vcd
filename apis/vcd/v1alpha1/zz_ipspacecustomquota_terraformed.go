...
// GetInitParameters of this IpSpaceCustomQuota
func (tr *IpSpaceCustomQuota) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IpSpaceCustomQuota
func (tr *IpSpaceCustomQuota) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
