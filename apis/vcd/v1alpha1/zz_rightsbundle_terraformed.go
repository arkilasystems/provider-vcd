...
// GetInitParameters of this RightsBundle
func (tr *RightsBundle) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RightsBundle
func (tr *RightsBundle) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
