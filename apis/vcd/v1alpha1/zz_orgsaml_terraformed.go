...
// GetInitParameters of this OrgSaml
func (tr *OrgSaml) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this OrgSaml
func (tr *OrgSaml) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
