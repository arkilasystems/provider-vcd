...
// GetInitParameters of this IpSpaceIpAllocation
func (tr *IpSpaceIpAllocation) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IpSpaceIpAllocation
func (tr *IpSpaceIpAllocation) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
