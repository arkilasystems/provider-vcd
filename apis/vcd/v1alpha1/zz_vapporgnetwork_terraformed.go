...
// GetInitParameters of this VAppOrgNetwork
func (tr *VAppOrgNetwork) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VAppOrgNetwork
func (tr *VAppOrgNetwork) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VAppOrgNetwork using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VAppOrgNetwork) LateInitialize(attrs []byte) (bool, error) {
	params := &VAppOrgNetworkParameters{}
