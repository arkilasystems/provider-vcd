...
func (tr *VAppVm) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"customization[*].admin_password": "customization[*].adminPasswordSecretRef", "customization[*].join_domain_password": "customization[*].joinDomainPasswordSecretRef"}
}
...
// GetID returns ID of underlying Terraform resource of this VAppVm
...
// GetInitParameters of this VAppVm
func (tr *VAppVm) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VAppVm
func (tr *VAppVm) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VAppVm using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VAppVm) LateInitialize(attrs []byte) (bool, error) {
	params := &VAppVmParameters{}
