...
// GetInitParameters of this NsxtFirewall
func (tr *NsxtFirewall) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtFirewall
func (tr *NsxtFirewall) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
