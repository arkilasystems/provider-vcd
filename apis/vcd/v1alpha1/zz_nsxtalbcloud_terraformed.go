...
// GetInitParameters of this NsxtAlbCloud
func (tr *NsxtAlbCloud) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtAlbCloud
func (tr *NsxtAlbCloud) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
