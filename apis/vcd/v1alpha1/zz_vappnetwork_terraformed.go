...
// GetInitParameters of this VAppNetwork
func (tr *VAppNetwork) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VAppNetwork
func (tr *VAppNetwork) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VAppNetwork using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VAppNetwork) LateInitialize(attrs []byte) (bool, error) {
	params := &VAppNetworkParameters{}
