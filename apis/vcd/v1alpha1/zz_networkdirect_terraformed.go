...
// GetInitParameters of this NetworkDirect
func (tr *NetworkDirect) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NetworkDirect
func (tr *NetworkDirect) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
