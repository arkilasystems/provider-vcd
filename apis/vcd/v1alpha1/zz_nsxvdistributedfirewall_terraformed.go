...
// GetInitParameters of this NsxvDistributedFirewall
func (tr *NsxvDistributedFirewall) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxvDistributedFirewall
func (tr *NsxvDistributedFirewall) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
