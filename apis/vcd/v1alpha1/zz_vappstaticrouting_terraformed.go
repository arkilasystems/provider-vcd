...
// GetInitParameters of this VAppStaticRouting
func (tr *VAppStaticRouting) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VAppStaticRouting
func (tr *VAppStaticRouting) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VAppStaticRouting using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VAppStaticRouting) LateInitialize(attrs []byte) (bool, error) {
	params := &VAppStaticRoutingParameters{}
