...
// GetInitParameters of this CatalogMedia
func (tr *CatalogMedia) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this CatalogMedia
func (tr *CatalogMedia) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
