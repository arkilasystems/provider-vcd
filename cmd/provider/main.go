...
import (
	...
	"github.com/arkilasystems/provider-vcd/apis"
	"github.com/arkilasystems/provider-vcd/apis/v1alpha1"
	"github.com/arkilasystems/provider-vcd/config"
	"github.com/arkilasystems/provider-vcd/internal/clients"
	"github.com/arkilasystems/provider-vcd/internal/controller"
...
func main() {
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add Vcd APIs to scheme")
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Vcd controllers")
