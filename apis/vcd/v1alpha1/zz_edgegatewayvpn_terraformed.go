...
// GetInitParameters of this EdgegatewayVPN
func (tr *EdgegatewayVPN) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EdgegatewayVPN
func (tr *EdgegatewayVPN) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
