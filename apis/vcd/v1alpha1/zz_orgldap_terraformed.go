...
func (tr *OrgLdap) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"custom_settings[*].password": "customSettings[*].passwordSecretRef"}
}
...
// GetInitParameters of this OrgLdap
func (tr *OrgLdap) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this OrgLdap
func (tr *OrgLdap) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
