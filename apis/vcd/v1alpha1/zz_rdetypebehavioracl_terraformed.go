...
// GetInitParameters of this RdeTypeBehaviorAcl
func (tr *RdeTypeBehaviorAcl) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RdeTypeBehaviorAcl
func (tr *RdeTypeBehaviorAcl) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
