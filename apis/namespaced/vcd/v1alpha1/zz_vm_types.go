...
type VmBootOptionsObservation struct {
...
type VmBootOptionsParameters struct {
...
type VmCustomizationInitParameters struct {
	...
	JoinDomainPasswordSecretRef *v2.LocalSecretKeySelector `json:"joinDomainPasswordSecretRef,omitempty" tf:"-"`
...
type VmDiskInitParameters struct {
...
type VmExtraConfigInitParameters struct {
}

type VmExtraConfigObservation struct {
...
type VmExtraConfigParameters struct {
}
...
type VmInitParameters struct {
	...
	BootOptions []VmBootOptionsInitParameters `json:"bootOptions,omitempty" tf:"boot_options,omitempty"`
	...
	Customization []VmCustomizationInitParameters `json:"customization,omitempty" tf:"customization,omitempty"`

	// The VM description
	Description *string `json:"description,omitempty" tf:"description,omitempty"`

	Disk []VmDiskInitParameters `json:"disk,omitempty" tf:"disk,omitempty"`
	...
	MetadataEntry []VmMetadataEntryInitParameters `json:"metadataEntry,omitempty" tf:"metadata_entry,omitempty"`

	// A name for the VM, unique within the vApp
	Name *string `json:"name,omitempty" tf:"name,omitempty"`

	// A block to define network interface. Multiple can be used.
	Network []VmNetworkInitParameters `json:"network,omitempty" tf:"network,omitempty"`
	...
	OverrideTemplateDisk []VmOverrideTemplateDiskInitParameters `json:"overrideTemplateDisk,omitempty" tf:"override_template_disk,omitempty"`
	...
	SetExtraConfig []VmSetExtraConfigInitParameters `json:"setExtraConfig,omitempty" tf:"set_extra_config,omitempty"`
...
type VmInternalDiskInitParameters struct {
}
...
type VmMetadataEntryInitParameters struct {
...
type VmNetworkInitParameters struct {
...
type VmObservation struct {
	...
	// A block defining the boot options of a VM
	BootOptions []VmBootOptionsObservation `json:"bootOptions,omitempty" tf:"boot_options,omitempty"`
	...
	ExtraConfig []VmExtraConfigObservation `json:"extraConfig,omitempty" tf:"extra_config,omitempty"`
	...
	// A block to set extra configuration key-value pairs
	SetExtraConfig []VmSetExtraConfigObservation `json:"setExtraConfig,omitempty" tf:"set_extra_config,omitempty"`
...
type VmOverrideTemplateDiskInitParameters struct {
...
type VmParameters struct {
	...
	// A block defining the boot options of a VM
	// +kubebuilder:validation:Optional
	BootOptions []VmBootOptionsParameters `json:"bootOptions,omitempty" tf:"boot_options,omitempty"`
	...
	// A block to set extra configuration key-value pairs
	// +kubebuilder:validation:Optional
	SetExtraConfig []VmSetExtraConfigParameters `json:"setExtraConfig,omitempty" tf:"set_extra_config,omitempty"`
...
type VmSetExtraConfigInitParameters struct {
...
type VmSetExtraConfigObservation struct {
...
type VmSetExtraConfigParameters struct {
...
type VmSpec struct {
	...
	// autoscaler.
	InitProvider VmInitParameters `json:"initProvider,omitempty"`
}
...
// Vm is the Schema for the Vms API. Provides a VMware Cloud Director standalone VM resource. This can be used to create, modify, and delete Standalone VMs.
