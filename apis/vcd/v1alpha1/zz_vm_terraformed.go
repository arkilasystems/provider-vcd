...
// GetInitParameters of this Vm
func (tr *Vm) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Vm
func (tr *Vm) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
