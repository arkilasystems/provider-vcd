...
// GetInitParameters of this NsxtAlbController
func (tr *NsxtAlbController) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtAlbController
func (tr *NsxtAlbController) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
