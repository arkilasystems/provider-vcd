...
// GetInitParameters of this NsxvFirewallRule
func (tr *NsxvFirewallRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxvFirewallRule
func (tr *NsxvFirewallRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
