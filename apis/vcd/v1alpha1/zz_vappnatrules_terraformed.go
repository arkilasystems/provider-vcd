...
// GetInitParameters of this VAppNatRules
func (tr *VAppNatRules) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VAppNatRules
func (tr *VAppNatRules) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VAppNatRules using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VAppNatRules) LateInitialize(attrs []byte) (bool, error) {
	params := &VAppNatRulesParameters{}
