...
// GetInitParameters of this NsxtEdgeGatewayRateLimit
func (tr *NsxtEdgeGatewayRateLimit) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtEdgeGatewayRateLimit
func (tr *NsxtEdgeGatewayRateLimit) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
