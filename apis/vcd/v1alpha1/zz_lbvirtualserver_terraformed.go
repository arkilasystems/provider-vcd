...
// GetInitParameters of this LbVirtualServer
func (tr *LbVirtualServer) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LbVirtualServer
func (tr *LbVirtualServer) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
