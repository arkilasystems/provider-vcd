...
// GetInitParameters of this VmInternalDisk
func (tr *VmInternalDisk) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VmInternalDisk
func (tr *VmInternalDisk) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VmInternalDisk using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VmInternalDisk) LateInitialize(attrs []byte) (bool, error) {
	params := &VmInternalDiskParameters_2{}
