...
// GetInitParameters of this LbAppProfile
func (tr *LbAppProfile) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LbAppProfile
func (tr *LbAppProfile) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
