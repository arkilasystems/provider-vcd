...
// GetInitParameters of this EdgegatewaySettings
func (tr *EdgegatewaySettings) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EdgegatewaySettings
func (tr *EdgegatewaySettings) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
