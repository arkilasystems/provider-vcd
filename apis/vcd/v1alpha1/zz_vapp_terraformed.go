...
// GetInitParameters of this VApp
func (tr *VApp) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VApp
func (tr *VApp) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
