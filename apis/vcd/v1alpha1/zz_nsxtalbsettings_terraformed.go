...
// GetInitParameters of this NsxtAlbSettings
func (tr *NsxtAlbSettings) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtAlbSettings
func (tr *NsxtAlbSettings) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
