...
// GetInitParameters of this SecurityTag
func (tr *SecurityTag) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SecurityTag
func (tr *SecurityTag) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
