...
// GetInitParameters of this OrgGroup
func (tr *OrgGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this OrgGroup
func (tr *OrgGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
