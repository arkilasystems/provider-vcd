...
PROJECT_REPO ?= github.com/arkilasystems/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-vcd_v$(TERRAFORM_PROVIDER_VERSION)_x5
...
REGISTRY_ORGS ?= xpkg.upbound.io/arkilasystems
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/arkilasystems
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/arkilasystems
XPKGS = $(PROJECT_NAME)
...
xpkg.build.provider-vcd: do.build.images
