...
// GetInitParameters of this NsxvIpSet
func (tr *NsxvIpSet) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxvIpSet
func (tr *NsxvIpSet) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
