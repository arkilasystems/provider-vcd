...
// GetInitParameters of this VmPlacementPolicy
func (tr *VmPlacementPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VmPlacementPolicy
func (tr *VmPlacementPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VmPlacementPolicy using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VmPlacementPolicy) LateInitialize(attrs []byte) (bool, error) {
	params := &VmPlacementPolicyParameters{}
