...
// GetInitParameters of this IpSpace
func (tr *IpSpace) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IpSpace
func (tr *IpSpace) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
