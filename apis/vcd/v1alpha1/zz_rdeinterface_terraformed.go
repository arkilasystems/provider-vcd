...
// GetInitParameters of this RdeInterface
func (tr *RdeInterface) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RdeInterface
func (tr *RdeInterface) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
