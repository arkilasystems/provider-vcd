...
// GetInitParameters of this CatalogvAppTemplate
func (tr *CatalogvAppTemplate) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this CatalogvAppTemplate
func (tr *CatalogvAppTemplate) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
