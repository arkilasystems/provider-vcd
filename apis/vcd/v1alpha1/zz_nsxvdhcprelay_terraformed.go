...
// GetInitParameters of this NsxvDhcpRelay
func (tr *NsxvDhcpRelay) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxvDhcpRelay
func (tr *NsxvDhcpRelay) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
