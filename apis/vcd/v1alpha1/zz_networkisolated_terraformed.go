...
// GetInitParameters of this NetworkIsolated
func (tr *NetworkIsolated) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NetworkIsolated
func (tr *NetworkIsolated) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
