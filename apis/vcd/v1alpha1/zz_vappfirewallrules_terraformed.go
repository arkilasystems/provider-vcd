...
// GetInitParameters of this VAppFirewallRules
func (tr *VAppFirewallRules) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VAppFirewallRules
func (tr *VAppFirewallRules) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VAppFirewallRules using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VAppFirewallRules) LateInitialize(attrs []byte) (bool, error) {
	params := &VAppFirewallRulesParameters{}
