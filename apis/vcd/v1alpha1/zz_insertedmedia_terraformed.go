...
// GetInitParameters of this InsertedMedia
func (tr *InsertedMedia) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this InsertedMedia
func (tr *InsertedMedia) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
