...
// GetInitParameters of this OrgVdc
func (tr *OrgVdc) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this OrgVdc
func (tr *OrgVdc) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
