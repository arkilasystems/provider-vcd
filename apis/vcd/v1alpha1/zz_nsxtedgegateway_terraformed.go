...
// GetInitParameters of this NsxtEdgeGateway
func (tr *NsxtEdgeGateway) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtEdgeGateway
func (tr *NsxtEdgeGateway) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
func (tr *NsxtEdgeGateway) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("Vdc"))
