...
// GetInitParameters of this NetworkRouted
func (tr *NetworkRouted) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NetworkRouted
func (tr *NetworkRouted) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
