...
// GetInitParameters of this RdeTypeBehavior
func (tr *RdeTypeBehavior) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RdeTypeBehavior
func (tr *RdeTypeBehavior) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
