...
// GetInitParameters of this ClonedvApp
func (tr *ClonedvApp) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ClonedvApp
func (tr *ClonedvApp) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
