...
func (tr *SubscribedCatalog) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"subscription_password": "subscriptionPasswordSecretRef"}
}
...
// GetInitParameters of this SubscribedCatalog
func (tr *SubscribedCatalog) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SubscribedCatalog
func (tr *SubscribedCatalog) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
