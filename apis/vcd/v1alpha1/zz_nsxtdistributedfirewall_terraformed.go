...
// GetInitParameters of this NsxtDistributedFirewall
func (tr *NsxtDistributedFirewall) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtDistributedFirewall
func (tr *NsxtDistributedFirewall) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
