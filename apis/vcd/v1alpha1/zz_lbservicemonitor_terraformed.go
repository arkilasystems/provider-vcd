...
// GetInitParameters of this LbServiceMonitor
func (tr *LbServiceMonitor) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LbServiceMonitor
func (tr *LbServiceMonitor) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
