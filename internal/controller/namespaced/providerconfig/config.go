...
import (
	...
	"github.com/arkilasystems/provider-vcd/apis/namespaced/v1beta1"
)

// SetupWebhookWithManager registers the conversion webhooks for
...
// ClusterProviderConfigs by accounting for their current usage, deferring
// Setup until their CRDs are known to exist.
