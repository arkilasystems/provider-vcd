...
// GetInitParameters of this CatalogItem
func (tr *CatalogItem) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this CatalogItem
func (tr *CatalogItem) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
