...
// GetInitParameters of this NsxtDynamicSecurityGroup
func (tr *NsxtDynamicSecurityGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtDynamicSecurityGroup
func (tr *NsxtDynamicSecurityGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
