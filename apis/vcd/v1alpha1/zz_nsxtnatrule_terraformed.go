...
// GetInitParameters of this NsxtNatRule
func (tr *NsxtNatRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtNatRule
func (tr *NsxtNatRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
