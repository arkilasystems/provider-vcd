...
// GetInitParameters of this NetworkRoutedV2
func (tr *NetworkRoutedV2) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NetworkRoutedV2
func (tr *NetworkRoutedV2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
