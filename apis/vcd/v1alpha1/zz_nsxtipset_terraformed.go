...
// GetInitParameters of this NsxtIpSet
func (tr *NsxtIpSet) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtIpSet
func (tr *NsxtIpSet) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
