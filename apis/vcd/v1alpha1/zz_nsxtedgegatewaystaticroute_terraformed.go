...
// GetInitParameters of this NsxtEdgeGatewayStaticRoute
func (tr *NsxtEdgeGatewayStaticRoute) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxtEdgeGatewayStaticRoute
func (tr *NsxtEdgeGatewayStaticRoute) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
