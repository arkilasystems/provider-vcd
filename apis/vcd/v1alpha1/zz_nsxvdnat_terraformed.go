...
// GetInitParameters of this NsxvDnat
func (tr *NsxvDnat) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NsxvDnat
func (tr *NsxvDnat) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
